...
@protocol QYKFMTLJSONSerializing
@required
...
+ (NSDictionary *)JSONDictionaryFromModel:(QYKFMTLModel<QYKFMTLJSONSerializing> *)model;
...
// model - The model to use for JSON serialization. This argument must not be
//         nil.
- (id)initWithModel:(QYKFMTLModel<QYKFMTLJSONSerializing> *)model;
...
@interface QYKFMTLJSONAdapter (Deprecated)
