...
FOUNDATION_EXPORT NSString *const QYKFAWSSTSErrorDomain;

typedef NS_ENUM(NSInteger, QYKFAWSSTSErrorType) {
    QYKFAWSSTSErrorUnknown,
    QYKFAWSSTSErrorExpiredToken,
    QYKFAWSSTSErrorIDPCommunicationError,
    QYKFAWSSTSErrorIDPRejectedClaim,
    QYKFAWSSTSErrorInvalidAuthorizationMessage,
    QYKFAWSSTSErrorInvalidIdentityToken,
    QYKFAWSSTSErrorMalformedPolicyDocument,
    QYKFAWSSTSErrorPackedPolicyTooLarge,
    QYKFAWSSTSErrorRegionDisabled,
};

@class QYKFAWSSTSAssumeRoleRequest;
@class QYKFAWSSTSAssumeRoleResponse;
@class QYKFAWSSTSAssumeRoleWithSAMLRequest;
@class QYKFAWSSTSAssumeRoleWithSAMLResponse;
@class QYKFAWSSTSAssumeRoleWithWebIdentityRequest;
@class QYKFAWSSTSAssumeRoleWithWebIdentityResponse;
@class QYKFAWSSTSAssumedRoleUser;
@class QYKFAWSSTSCredentials;
@class QYKFAWSSTSDecodeAuthorizationMessageRequest;
@class QYKFAWSSTSDecodeAuthorizationMessageResponse;
@class QYKFAWSSTSFederatedUser;
@class QYKFAWSSTSGetAccessKeyInfoRequest;
@class QYKFAWSSTSGetAccessKeyInfoResponse;
@class QYKFAWSSTSGetCallerIdentityRequest;
@class QYKFAWSSTSGetCallerIdentityResponse;
@class QYKFAWSSTSGetFederationTokenRequest;
@class QYKFAWSSTSGetFederationTokenResponse;
@class QYKFAWSSTSGetSessionTokenRequest;
@class QYKFAWSSTSGetSessionTokenResponse;
@class QYKFAWSSTSPolicyDescriptorType;
@class QYKFAWSSTSProvidedContext;
@class QYKFAWSSTSTag;

/**
 
 */
@interface QYKFAWSSTSAssumeRoleRequest : QYKFAWSRequest
 ...
 */
@property (nonatomic, strong) NSArray<QYKFAWSSTSPolicyDescriptorType *> * _Nullable policyArns;
 ...
 */
@property (nonatomic, strong) NSArray<QYKFAWSSTSProvidedContext *> * _Nullable providedContexts;
 ...
 */
@property (nonatomic, strong) NSArray<QYKFAWSSTSTag *> * _Nullable tags;
 ...
 */
@interface QYKFAWSSTSAssumeRoleResponse : QYKFAWSModel
 ...
 */
@property (nonatomic, strong) QYKFAWSSTSAssumedRoleUser * _Nullable assumedRoleUser;
 ...
 */
@property (nonatomic, strong) QYKFAWSSTSCredentials * _Nullable credentials;
 ...
 */
@interface QYKFAWSSTSAssumeRoleWithSAMLRequest : QYKFAWSRequest
 ...
 */
@interface QYKFAWSSTSAssumeRoleWithSAMLResponse : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSAssumeRoleWithWebIdentityRequest : QYKFAWSRequest
 ...
 */
@interface QYKFAWSSTSAssumeRoleWithWebIdentityResponse : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSAssumedRoleUser : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSCredentials : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSDecodeAuthorizationMessageRequest : QYKFAWSRequest
 ...
 */
@interface QYKFAWSSTSDecodeAuthorizationMessageResponse : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSFederatedUser : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSGetAccessKeyInfoRequest : QYKFAWSRequest
 ...
 */
@interface QYKFAWSSTSGetAccessKeyInfoResponse : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSGetCallerIdentityRequest : QYKFAWSRequest
 ...
 */
@interface QYKFAWSSTSGetCallerIdentityResponse : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSGetFederationTokenRequest : QYKFAWSRequest
 ...
 */
@interface QYKFAWSSTSGetFederationTokenResponse : QYKFAWSModel
 ...
 */
@property (nonatomic, strong) QYKFAWSSTSFederatedUser * _Nullable federatedUser;
 ...
 */
@interface QYKFAWSSTSGetSessionTokenRequest : QYKFAWSRequest
 ...
 */
@interface QYKFAWSSTSGetSessionTokenResponse : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSPolicyDescriptorType : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSProvidedContext : QYKFAWSModel
 ...
 */
@interface QYKFAWSSTSTag : QYKFAWSModel
