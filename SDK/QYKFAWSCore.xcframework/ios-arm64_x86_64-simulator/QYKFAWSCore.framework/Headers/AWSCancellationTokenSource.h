...
@class QYKFCancellationToken;

/*!
 QYKFCancellationTokenSource represents the producer side of a CancellationToken.
 Signals to a CancellationToken that it should be canceled.
 It is a cancellation token that also has methods
 for changing the state of a token by cancelling it.
 */
@interface QYKFCancellationTokenSource : NSObject
 ...
 */
@property (nonatomic, strong, readonly) QYKFCancellationToken *token;
