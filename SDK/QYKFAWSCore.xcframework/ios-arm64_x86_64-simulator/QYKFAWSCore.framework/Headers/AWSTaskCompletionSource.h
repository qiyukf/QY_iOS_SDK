...
/*!
 A QYKFTaskCompletionSource represents the producer side of tasks.
 It is a task that also has methods for changing the state of the
 task by settings its completion values.
 */
@interface QYKFTaskCompletionSource<__covariant ResultType> : NSObject
 ...
 */
@property (nonatomic, strong, readonly) QYKFTask<ResultType> *task;
