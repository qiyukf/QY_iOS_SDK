...
FOUNDATION_EXPORT NSString *const QYKFAWSClientContextVersion;
FOUNDATION_EXPORT NSString *const QYKFAWSClientContextHeader;
FOUNDATION_EXPORT NSString *const QYKFAWSClientContextHeaderEncoding;

@interface QYKFAWSClientContext : NSObject
