...
@interface QYKFMTLModel : NSObject <NSCopying>
...
- (void)mergeValueForKey:(NSString *)key fromModel:(QYKFMTLModel *)model;
...
- (void)mergeValuesForKeysFromModel:(QYKFMTLModel *)model;
...
@interface QYKFMTLModel (Validation)
...
@interface QYKFMTLModel (Unavailable)
