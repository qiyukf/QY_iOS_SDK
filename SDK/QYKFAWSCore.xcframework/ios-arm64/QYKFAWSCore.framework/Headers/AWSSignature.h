...
FOUNDATION_EXPORT NSString * _Nonnull const QYKFAWSSignatureV4Algorithm;
FOUNDATION_EXPORT NSString * _Nonnull const QYKFAWSSignatureV4Terminator;

@class QYKFAWSEndpoint;

@protocol QYKFAWSCredentialsProvider;

@interface QYKFAWSSignatureSignerUtility : NSObject
...
@interface QYKFAWSSignatureV4Signer : NSObject <QYKFAWSNetworkingRequestInterceptor>

@property (nonatomic, strong, readonly) id<QYKFAWSCredentialsProvider> _Nonnull credentialsProvider;

- (instancetype _Nonnull)initWithCredentialsProvider:(id<QYKFAWSCredentialsProvider> _Nonnull)credentialsProvider
                                   endpoint:(QYKFAWSEndpoint * _Nonnull)endpoint;
 ...
 */
+ (QYKFTask<NSURL *> * _Nonnull)generateQueryStringForSignatureV4WithCredentialProvider:(id<QYKFAWSCredentialsProvider> _Nonnull)credentialsProvider
                                                                            httpMethod:(QYKFAWSHTTPMethod)httpMethod
...
/**
 Returns a NSDictionary contains URL(key by "URL") and headers(key by "headers") signed using the SigV4 algorithm, using the current date, and including the session token (if any) as
 part of the signed query paramters.
 ...
 @param requestParameters the URL parameters to sign
 @param signBody if true and the httpMethod is GET, sign an empty string as part of the signature content
 @return a task containing NSDictionary including the signed URL and headers
 */
+ (QYKFTask<NSDictionary *> * _Nonnull)generateQueryStringAndHeadersForSignatureV4WithCredentialProvider:(id<QYKFAWSCredentialsProvider> _Nonnull)credentialsProvider
                                                                                             httpMethod:(QYKFAWSHTTPMethod)httpMethod
                                                                                         expireDuration:(int32_t)expireDuration
                                                                                               endpoint:(QYKFAWSEndpoint * _Nonnull)endpoint
                                                                                                keyPath:(NSString * _Nullable)keyPath
...
/**
 ...
 @return a task containing the signed URL
 */
+ (QYKFTask<NSURL *> * _Nonnull)sigV4SignedURLWithRequest:(NSURLRequest * _Nonnull)request
                                      credentialProvider:(id<QYKFAWSCredentialsProvider> _Nonnull)credentialsProvider
...
// added by hzsusu@corp.netease.com
/**
 Returns a NSDictionary contains a URL(key by "URL") and headers(key by "headers") signed using the SigV4 algorithm.
 ...
 @return a task containing NSDictionary including the signed URL and headers
 */
+ (QYKFTask<NSDictionary *> * _Nonnull)sigV4SignedURLAndHeadersWithRequest:(NSURLRequest * _Nonnull)request
                                                       credentialProvider:(id<QYKFAWSCredentialsProvider> _Nonnull)credentialsProvider
                                                               regionName:(NSString * _Nonnull)regionName
                                                              serviceName:(NSString * _Nonnull)serviceName
                                                                     date:(NSDate * _Nonnull)date
...
@interface QYKFAWSSignatureV2Signer : NSObject <QYKFAWSNetworkingRequestInterceptor>

@property (nonatomic, strong, readonly) id<QYKFAWSCredentialsProvider> _Nullable credentialsProvider;

+ (instancetype _Nonnull)signerWithCredentialsProvider:(id<QYKFAWSCredentialsProvider> _Nonnull)credentialsProvider
                                     endpoint:(QYKFAWSEndpoint * _Nonnull)endpoint;
 ...
 **/
@interface QYKFAWSS3ChunkedEncodingInputStream : NSInputStream <NSStreamDelegate>
