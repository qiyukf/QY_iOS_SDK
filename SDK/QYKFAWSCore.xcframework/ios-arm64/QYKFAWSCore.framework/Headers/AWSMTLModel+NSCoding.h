...
void QYKFmtl_loadMTLNSCoding(void);
...
typedef enum : NSUInteger {
    QYKFMTLModelEncodingBehaviorExcluded = 0,
    QYKFMTLModelEncodingBehaviorUnconditional,
    QYKFMTLModelEncodingBehaviorConditional,
} QYKFMTLModelEncodingBehavior;

// Implements default archiving and unarchiving behaviors for MTLModel.
@interface QYKFMTLModel (NSCoding) <NSCoding>
...
@interface QYKFMTLModel (OldArchiveSupport)
