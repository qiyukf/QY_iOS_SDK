...
// NSManagedObject.
@protocol QYKFMTLManagedObjectSerializing
@required
...
extern NSString * const QYKFMTLManagedObjectAdapterErrorDomain;

// +classForDeserializingManagedObject: returned nil for the given object.
extern const NSInteger QYKFMTLManagedObjectAdapterErrorNoClassFound;

// An NSManagedObject failed to initialize.
extern const NSInteger QYKFMTLManagedObjectAdapterErrorInitializationFailed;

// The managed object key specified by +managedObjectKeysByPropertyKey does not
// exist in the NSEntityDescription.
extern const NSInteger QYKFMTLManagedObjectAdapterErrorInvalidManagedObjectKey;

// The managed object property specified has a type that isn't supported by
// MTLManagedObjectAdapter.
extern const NSInteger QYKFMTLManagedObjectAdapterErrorUnsupportedManagedObjectPropertyType;

// The fetch request to find an existing managed object based on
// `+propertyKeysForManagedObjectUniquing` failed.
extern const NSInteger QYKFMTLManagedObjectAdapterErrorUniqueFetchRequestFailed;
...
extern const NSInteger QYKFMTLManagedObjectAdapterErrorUnsupportedRelationshipClass;

// The model's implementation of +managedObjectKeysByPropertyKey included a key
// which does not actually exist in +propertyKeys.
extern const NSInteger QYKFMTLManagedObjectAdapterErrorInvalidManagedObjectMapping;

// Converts a MTLModel object to and from an NSManagedObject.
@interface QYKFMTLManagedObjectAdapter : NSObject
...
+ (id)managedObjectFromModel:(QYKFMTLModel<QYKFMTLManagedObjectSerializing> *)model insertingIntoContext:(NSManagedObjectContext *)context error:(NSError **)error;
