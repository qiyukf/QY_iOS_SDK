...
@interface NSDictionary (QYKFMTLManipulationAdditions)
...
// those of `dictionary`.
- (NSDictionary *)QYKFmtl_dictionaryByAddingEntriesFromDictionary:(NSDictionary *)dictionary;

// Creates a new dictionary with all the entries for the given keys removed from
// the receiver.
- (NSDictionary *)QYKFmtl_dictionaryByRemovingEntriesWithKeys:(NSSet *)keys;
