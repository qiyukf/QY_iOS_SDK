...
@interface QYKFAWSJSONResponseSerializer : NSObject <QYKFAWSHTTPURLResponseSerializer>
...
@interface QYKFAWSXMLResponseSerializer : NSObject <QYKFAWSHTTPURLResponseSerializer>
