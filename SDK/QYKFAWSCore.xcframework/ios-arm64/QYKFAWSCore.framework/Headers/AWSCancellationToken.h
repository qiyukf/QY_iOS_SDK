 ...
 */
typedef void(^QYKFCancellationBlock)(void);

/*!
 The consumer view of a CancellationToken.
 Propagates notification that operations should be canceled.
 A QYKFCancellationToken has methods to inspect whether the token has been cancelled.
 */
@interface QYKFCancellationToken : NSObject
 ...
 */
- (QYKFCancellationTokenRegistration *)registerCancellationObserverWithBlock:(QYKFCancellationBlock)block;
