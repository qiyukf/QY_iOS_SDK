...
extern NSString * const QYKFUICKeyChainStoreErrorDomain;

typedef NS_ENUM(NSInteger, QYKFUICKeyChainStoreErrorCode) {
    QYKFUICKeyChainStoreErrorInvalidArguments = 1,
};

typedef NS_ENUM(NSInteger, QYKFUICKeyChainStoreItemClass) {
    QYKFUICKeyChainStoreItemClassGenericPassword = 1,
    QYKFUICKeyChainStoreItemClassInternetPassword,
};

typedef NS_ENUM(NSInteger, QYKFUICKeyChainStoreProtocolType) {
    QYKFUICKeyChainStoreProtocolTypeFTP = 1,
    QYKFUICKeyChainStoreProtocolTypeFTPAccount,
    QYKFUICKeyChainStoreProtocolTypeHTTP,
    QYKFUICKeyChainStoreProtocolTypeIRC,
    QYKFUICKeyChainStoreProtocolTypeNNTP,
    QYKFUICKeyChainStoreProtocolTypePOP3,
    QYKFUICKeyChainStoreProtocolTypeSMTP,
    QYKFUICKeyChainStoreProtocolTypeSOCKS,
    QYKFUICKeyChainStoreProtocolTypeIMAP,
    QYKFUICKeyChainStoreProtocolTypeLDAP,
    QYKFUICKeyChainStoreProtocolTypeAppleTalk,
    QYKFUICKeyChainStoreProtocolTypeAFP,
    QYKFUICKeyChainStoreProtocolTypeTelnet,
    QYKFUICKeyChainStoreProtocolTypeSSH,
    QYKFUICKeyChainStoreProtocolTypeFTPS,
    QYKFUICKeyChainStoreProtocolTypeHTTPS,
    QYKFUICKeyChainStoreProtocolTypeHTTPProxy,
    QYKFUICKeyChainStoreProtocolTypeHTTPSProxy,
    QYKFUICKeyChainStoreProtocolTypeFTPProxy,
    QYKFUICKeyChainStoreProtocolTypeSMB,
    QYKFUICKeyChainStoreProtocolTypeRTSP,
    QYKFUICKeyChainStoreProtocolTypeRTSPProxy,
    QYKFUICKeyChainStoreProtocolTypeDAAP,
    QYKFUICKeyChainStoreProtocolTypeEPPC,
    QYKFUICKeyChainStoreProtocolTypeNNTPS,
    QYKFUICKeyChainStoreProtocolTypeLDAPS,
    QYKFUICKeyChainStoreProtocolTypeTelnetS,
    QYKFUICKeyChainStoreProtocolTypeIRCS,
    QYKFUICKeyChainStoreProtocolTypePOP3S,
};

typedef NS_ENUM(NSInteger, QYKFUICKeyChainStoreAuthenticationType) {
    QYKFUICKeyChainStoreAuthenticationTypeNTLM = 1,
    QYKFUICKeyChainStoreAuthenticationTypeMSN,
    QYKFUICKeyChainStoreAuthenticationTypeDPA,
    QYKFUICKeyChainStoreAuthenticationTypeRPA,
    QYKFUICKeyChainStoreAuthenticationTypeHTTPBasic,
    QYKFUICKeyChainStoreAuthenticationTypeHTTPDigest,
    QYKFUICKeyChainStoreAuthenticationTypeHTMLForm,
    QYKFUICKeyChainStoreAuthenticationTypeDefault,
};

typedef NS_ENUM(NSInteger, QYKFUICKeyChainStoreAccessibility) {
    QYKFUICKeyChainStoreAccessibilityWhenUnlocked = 1,
    QYKFUICKeyChainStoreAccessibilityAfterFirstUnlock,
    QYKFUICKeyChainStoreAccessibilityAlways,
    QYKFUICKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly
    __OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_8_0),
    QYKFUICKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly,
    QYKFUICKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly,
    QYKFUICKeyChainStoreAccessibilityAlwaysThisDeviceOnly,
}
__OSX_AVAILABLE_STARTING(__MAC_10_9, __IPHONE_4_0);

typedef NS_ENUM(NSInteger, QYKFUICKeyChainStoreAuthenticationPolicy) {
    QYKFUICKeyChainStoreAuthenticationPolicyUserPresence = kSecAccessControlUserPresence,
};

@interface QYKFUICKeyChainStore : NSObject

@property (nonatomic, readonly) QYKFUICKeyChainStoreItemClass itemClass;

@property (nonatomic, readonly, nullable) NSString *service;
@property (nonatomic, readonly, nullable) NSString *accessGroup;

@property (nonatomic, readonly, nullable) NSURL *server;
@property (nonatomic, readonly) QYKFUICKeyChainStoreProtocolType protocolType;
@property (nonatomic, readonly) QYKFUICKeyChainStoreAuthenticationType authenticationType;

@property (nonatomic) QYKFUICKeyChainStoreAccessibility accessibility;
@property (nonatomic, readonly) QYKFUICKeyChainStoreAuthenticationPolicy authenticationPolicy
__OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_8_0);
...
+ (QYKFUICKeyChainStore *)keyChainStore;
+ (QYKFUICKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (QYKFUICKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;

+ (QYKFUICKeyChainStore *)keyChainStoreWithServer:(NSURL *)server protocolType:(QYKFUICKeyChainStoreProtocolType)protocolType;
+ (QYKFUICKeyChainStore *)keyChainStoreWithServer:(NSURL *)server protocolType:(QYKFUICKeyChainStoreProtocolType)protocolType authenticationType:(QYKFUICKeyChainStoreAuthenticationType)authenticationType;
...
- (instancetype)initWithServer:(NSURL *)server protocolType:(QYKFUICKeyChainStoreProtocolType)protocolType;
- (instancetype)initWithServer:(NSURL *)server protocolType:(QYKFUICKeyChainStoreProtocolType)protocolType authenticationType:(QYKFUICKeyChainStoreAuthenticationType)authenticationType;
...
+ (nullable NSArray UIC_KEY_TYPE *)allKeysWithItemClass:(QYKFUICKeyChainStoreItemClass)itemClass;
- (nullable NSArray UIC_KEY_TYPE *)allKeys;

+ (nullable NSArray *)allItemsWithItemClass:(QYKFUICKeyChainStoreItemClass)itemClass;
- (nullable NSArray *)allItems;

- (void)setAccessibility:(QYKFUICKeyChainStoreAccessibility)accessibility authenticationPolicy:(QYKFUICKeyChainStoreAuthenticationPolicy)authenticationPolicy
__OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_8_0);
...
@interface QYKFUICKeyChainStore (ErrorHandling)
...
@interface QYKFUICKeyChainStore (ForwardCompatibility)
