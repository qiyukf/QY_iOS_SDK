...
void QYKFmtl_loadMTLPredefinedTransformerAdditions(void);

// The name for a value transformer that converts strings into URLs and back.
extern NSString * const QYKFMTLURLValueTransformerName;
...
// proper boolean.
extern NSString * const QYKFMTLBooleanValueTransformerName;

@interface NSValueTransformer (QYKFMTLPredefinedTransformerAdditions)
...
+ (NSValueTransformer *)QYKFmtl_JSONDictionaryTransformerWithModelClass:(Class)modelClass;
...
+ (NSValueTransformer *)QYKFmtl_JSONArrayTransformerWithModelClass:(Class)modelClass;
...
// representation.
//
//   NSValueTransformer *valueTransformer = [NSValueTransformer QYKFmtl_valueMappingTransformerWithDictionary:@{
//     @"foo": @(EnumDataTypeFoo),
//     @"bar": @(EnumDataTypeBar),
...
+ (NSValueTransformer *)QYKFmtl_valueMappingTransformerWithDictionary:(NSDictionary *)dictionary defaultValue:(id)defaultValue reverseDefaultValue:(id)reverseDefaultValue;
...
+ (NSValueTransformer *)QYKFmtl_valueMappingTransformerWithDictionary:(NSDictionary *)dictionary;

@end

@interface NSValueTransformer (UnavailableQYKFMTLPredefinedTransformerAdditions)

+ (NSValueTransformer *)QYKFmtl_externalRepresentationTransformerWithModelClass:(Class)modelClass __attribute__((deprecated("Replaced by +mtl_JSONDictionaryTransformerWithModelClass:")));
+ (NSValueTransformer *)QYKFmtl_externalRepresentationArrayTransformerWithModelClass:(Class)modelClass __attribute__((deprecated("Replaced by +mtl_JSONArrayTransformerWithModelClass:")));
