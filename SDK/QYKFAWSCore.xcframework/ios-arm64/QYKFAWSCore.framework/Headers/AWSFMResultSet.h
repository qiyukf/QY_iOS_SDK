...
@interface QYKFAWSFMResultSet : NSObject {
    QYKFAWSFMDatabase          *_parentDB;
    QYKFAWSFMStatement         *_statement;
...
@property (atomic, retain) QYKFAWSFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(QYKFAWSFMStatement *)statement usingParentDatabase:(QYKFAWSFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(QYKFAWSFMDatabase *)newDb;
