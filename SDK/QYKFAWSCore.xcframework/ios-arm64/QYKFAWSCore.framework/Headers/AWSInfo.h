...
FOUNDATION_EXPORT NSString *const QYKFAWSInfoDefault;

@class QYKFAWSServiceInfo;
@class QYKFAWSCognitoCredentialsProvider;
@class QYKFAWSServiceConfiguration;
/**
 * The AWSInfo holds the configuration values for the various supported services.
 */
@interface QYKFAWSInfo : NSObject
 ...
 */
+ (void)configureIdentityPoolService:(nullable QYKFAWSServiceConfiguration *)config;

- (nullable QYKFAWSServiceInfo *)serviceInfo:(NSString *)serviceName
                                  forKey:(NSString *)key;

- (nullable QYKFAWSServiceInfo *)defaultServiceInfo:(NSString *)serviceName;

@end

@interface QYKFAWSServiceInfo : NSObject

@property (nonatomic, readonly) QYKFAWSCognitoCredentialsProvider *cognitoCredentialsProvider;
