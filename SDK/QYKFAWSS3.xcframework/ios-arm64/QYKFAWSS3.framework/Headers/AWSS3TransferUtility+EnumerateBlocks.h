...
@interface QYKFAWSS3TransferUtility (EnumerateBlocks)
...
- (void)enumerateToAssignBlocks:(QYKFAWSS3TransferUtilityBlocks *)blocks NS_SWIFT_NAME(enumerateToAssign(blocks:));
