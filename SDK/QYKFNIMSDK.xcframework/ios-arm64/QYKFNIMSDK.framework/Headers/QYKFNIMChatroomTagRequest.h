 ...
 */
@interface QYKFNIMChatroomTempMuteTagRequest : NSObject
 ...
 *  根据用户标签获取聊天室成员请求
 */
@interface QYKFNIMChatroomFetchMembersByTagRequest : NSObject
 ...
 *  根据用户标签获取聊天室在线成员数量请求
 */
@interface QYKFNIMChatroomQueryMembersCountByTagRequest : NSObject
...
@interface QYKFNIMChatroomLocation : NSObject
...
@interface QYKFNIMChatroomTagsUpdate : NSObject
