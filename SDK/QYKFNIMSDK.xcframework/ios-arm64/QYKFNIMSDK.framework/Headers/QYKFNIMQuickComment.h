...
@class QYKFNIMQuickCommentSetting;
 ...
 *  快捷评论
 */
@interface QYKFNIMQuickComment : NSObject <NSCopying>
/**
 *  评论发送方
 */
 ...
 *  评论设置
 */
@property (nonatomic,strong,nullable) QYKFNIMQuickCommentSetting *setting;
/**
 *  评论所在的消息
 */
@property (nonatomic,strong,readonly) QYKFNIMMessage *message;
/**
 *  评论所在消息的元信息
 */
@property (nonatomic,strong,readonly) QYKFNIMChatExtendBasicInfo *basicInfo;
 ...
 * 快捷评论推送设置
 */
@interface QYKFNIMQuickCommentSetting : NSObject <NSCopying>
/**
 * 是否需要推送，默认NO，不推送
 */
