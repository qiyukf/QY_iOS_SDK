 ...
 *  图片格式
 */
typedef NS_ENUM(NSInteger, QYKFNIMImageFormat)
{
    /**
     *  Jpeg格式
     */
    QYKFNIMImageFormatJPEG,
    /**
     *  Png格式
     */
    QYKFNIMImageFormatPNG,
};

/**
 *  图片选项
 */
@interface QYKFNIMImageOption : NSObject
/**
 ...
 *  图片压缩格式,默认为JPEG
 */
@property (nonatomic,assign)    QYKFNIMImageFormat format;
 ...
 *  图片实例对象
 */
@interface QYKFNIMImageObject : NSObject<QYKFNIMMessageObject>
 ...
 */
@property (nullable, nonatomic ,strong) QYKFNIMImageOption *option;
