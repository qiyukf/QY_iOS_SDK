 ...
 */
@interface QYKFNIMAntiSpamOption : NSObject
...
/**
 *  是否命中客户端反垃圾
 *  @discussion 默认为NO，使用 QYKFNIMAntispamManager 中的 checkLocalAntispam:error: 方法来确定所给文本是否命中客户端本地反垃圾，根据结果填写这个字段
 */
 ...
 */
@interface QYKFNIMLocalAntiSpamCheckOption : NSObject
 ...
 * @discussion 这个选项用于反垃圾的本地检查，可以用这个选项进行一些字符串的本地替换操作
 */
@interface QYKFNIMLocalAntiSpamCheckResult : NSObject
