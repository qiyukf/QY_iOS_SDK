...
@class QYKFNIMSignalingPushInfo;
 ...
 *  创建频道请求
 */
@interface QYKFNIMSignalingCreateChannelRequest : NSObject
 ...
 *  延迟频道有效期（同时延迟操作者和频道）
 */
@interface QYKFNIMSignalingDelayChannelRequest : NSObject
 ...
 *  关闭频道请求
 */
@interface QYKFNIMSignalingCloseChannelRequest : NSObject
 ...
 *  加入频道请求
 */
@interface QYKFNIMSignalingJoinChannelRequest : NSObject
 ...
 *  离开频道请求
 */
@interface QYKFNIMSignalingLeaveChannelRequest : NSObject
 ...
 *  邀请加入频道请求
 */
@interface QYKFNIMSignalingInviteRequest : NSObject
 ...
 *  取消邀请请求
 */
@interface QYKFNIMSignalingCancelInviteRequest : NSObject
 ...
 *  拒绝邀请请求
 */
@interface QYKFNIMSignalingRejectRequest : NSObject
 ...
 *  接受邀请请求
 */
@interface QYKFNIMSignalingAcceptRequest : NSObject
 ...
 *  接受邀请请求
 */
@interface QYKFNIMSignalingJoinAndAcceptRequest : NSObject
 ...
 *  呼叫请求
 */
@interface QYKFNIMSignalingCallExRequest : NSObject
/**
 频道类型，必填
 */
@property(nonatomic, assign) QYKFNIMSignalingChannelType channelType;
 ...
 *  自定义控制指令请求
 */
@interface QYKFNIMSignalingControlRequest : NSObject
 ...
 *  呼叫请求（组合：创建、加入、邀请）
 */
@interface QYKFNIMSignalingCallRequest : QYKFNIMSignalingCreateChannelRequest
...
/**
 通知事件额外字段，非必填
 */
@property(nullable, nonatomic, strong) QYKFNIMSignalingPushInfo *push;
 ...
 *  查询请求
 */
@interface QYKFNIMSignalingQueryChannelRequest : NSObject
