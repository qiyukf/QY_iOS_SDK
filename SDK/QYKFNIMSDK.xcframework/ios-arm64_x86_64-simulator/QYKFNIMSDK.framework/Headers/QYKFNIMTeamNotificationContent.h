//
//  QYKFNIMTeamNotificationContent.h
//  NIMLib
//
//  Created by Netease
...
typedef NS_ENUM(NSInteger, NIMTeamUpdateTag){
    ...
    /**
     *  群全体禁言模式
     *  @discussion 参考QYKFNIMTeamAllMuteMode定义。0: 禁言关闭 1: 全员禁言，不包括管理员 3: 全员禁言，包括群组和管理员
     */
 ...
 *  群通知内容
 */
@interface QYKFNIMTeamNotificationContent : QYKFNIMNotificationContent
/**
 *  操作发起者ID
 */
 ...
 *  更新群信息的额外信息
 */
@interface QYKFNIMUpdateTeamInfoAttachment : NSObject
 ...
 *  禁言通知的额外信息
 */
@interface QYKFNIMMuteTeamMemberAttachment : NSObject
