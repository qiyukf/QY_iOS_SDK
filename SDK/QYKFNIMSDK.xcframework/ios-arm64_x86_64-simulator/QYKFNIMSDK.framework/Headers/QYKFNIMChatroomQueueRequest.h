 ...
 *  聊天室通用队列更新请求
 */
@interface QYKFNIMChatroomQueueUpdateRequest : NSObject
 ...
 *  聊天室通用队列取出请求
 */
@interface QYKFNIMChatroomQueueRemoveRequest : NSObject
 ...
 *  聊天室通用队列批量更新请求
 */
@interface QYKFNIMChatroomQueueBatchUpdateRequest : NSObject
