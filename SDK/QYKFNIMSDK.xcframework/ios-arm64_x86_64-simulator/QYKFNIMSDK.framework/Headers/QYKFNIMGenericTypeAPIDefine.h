 ...
 *  统一类型调用参数定义
 */
@interface QYKFNIMGenericTypeAPICallParam : NSObject
 ...
 *  统一类型调用结果参数定义
 */
@interface QYKFNIMGenericTypeAPICallResult : NSObject
 ...
 */
typedef void(^QYKFNIMGenericTypeAPICallInvokeCallback)(NSError * __nullable error, QYKFNIMGenericTypeAPICallResult * __nullable result);
