...
@class QYKFNIMUserInfo;

/**
 *  好友操作类型
 */
typedef NS_ENUM(NSInteger, QYKFNIMUserOperation){
    /**
     *  添加好友
     *  @discussion 直接添加为好友,无需验证
     */
    QYKFNIMUserOperationAdd     =   1,
    /**
     *  请求添加好友
     */
    QYKFNIMUserOperationRequest =   2,
    /**
     *  通过添加好友请求
     */
    QYKFNIMUserOperationVerify  =   3,
    /**
     *  拒绝添加好友请求
     */
    QYKFNIMUserOperationReject  =   4,
};

/**
 *  用户性别
 */
typedef NS_ENUM(NSInteger, QYKFNIMUserGender) {
    /**
     *  未知性别
     */
    QYKFNIMUserGenderUnknown,
    /**
     *  性别男
     */
    QYKFNIMUserGenderMale,
    /**
     *  性别女
     */
    QYKFNIMUserGenderFemale,
};

/**
 *  云信用户
 */
@interface QYKFNIMUser : NSObject
 ...
 *                        3.程序再次启动，此时会同步好友信息
 */
@property (nullable,nonatomic,strong,readonly) QYKFNIMUserInfo *userInfo;
 ...
 *  用户资料，仅当用户选择托管信息到云信时有效
 */
@interface QYKFNIMUserInfo : NSObject
 ...
 *  用户性别
 */
@property (nonatomic,assign,readonly) QYKFNIMUserGender gender;
 ...
 *  好友请求
 */
@interface QYKFNIMUserRequest : NSObject
/**
 *  目标用户ID
 */
 ...
 *  操作类型
 */
@property (nonatomic,assign)    QYKFNIMUserOperation    operation;
