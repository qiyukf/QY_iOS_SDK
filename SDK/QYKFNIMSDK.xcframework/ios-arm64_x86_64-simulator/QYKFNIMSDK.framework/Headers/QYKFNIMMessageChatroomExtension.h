//
//  QYKFNIMMessageChatroomExtension.h
//  NIMLib
//
//  Created by Netease.
...
/**
 *  消息内的聊天室拓展信息
 *  @discussion 用户进入聊天室时填的 QYKFNIMChatroomEnterRequest 中的额外信息将在发送聊天室信息时将转换为消息中聊天拓展信息
 */
@interface QYKFNIMMessageChatroomExtension : NSObject
/**
 *  用户在聊天室内的昵称
 */
