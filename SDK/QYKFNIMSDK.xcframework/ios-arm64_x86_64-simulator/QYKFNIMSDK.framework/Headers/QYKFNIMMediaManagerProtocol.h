 ...
 *  音频输出设备类型
 */
typedef NS_ENUM(NSInteger, QYKFNIMAudioOutputDevice){
    /**
     *  听筒
     */
    QYKFNIMAudioOutputDeviceReceiver,
    /**
     *  扬声器
     */
    QYKFNIMAudioOutputDeviceSpeaker
};

/**
 *  云信支持的音频类型
 */
typedef NS_ENUM(NSInteger, QYKFNIMAudioType) {
    /**
     *  aac
     */
    QYKFNIMAudioTypeAAC,
 ...
 *  @prarm text  转换后的文本
 */
typedef void(^QYKFNIMAudioToTextBlock)(NSError * __nullable error,NSString * __nullable text);


/**
 *  语音转文字选项
 */
@interface QYKFNIMAudioToTextOption : NSObject
 ...
 *  多媒体委托
 */
@protocol QYKFNIMMediaManagerDelegate <NSObject>
 ...
 *  多媒体控制协议
 */
@protocol QYKFNIMMediaManager <NSObject>
 ...
 *  @return 是否切换成功
 */
- (BOOL)switchAudioOutputDevice:(QYKFNIMAudioOutputDevice)outputDevice;
 ...
 *  播放音频文件
 *
 *  @discussion 开始播放，QYKFNIMMediaManagerDelegate中的playAudio:didBeganWithError:回调会被触发，播放完成后, QYKFNIMMediaManagerDelegate中的playAudio:didCompletedWithError:回调会被触发
 *  @param filepath 音频文件路径
 */
 ...
 *  停止播放音频
 *
 *  @discussion 音频播放完成后QYKFNIMMediaManagerDelegate中的playAudio:didCompletedWithError:回调会被触发
 */
- (void)stopPlay;
 ...
 *  @discussion 开始录音，QYKFNIMMediaManagerDelegate中的recordAudio:didBeganWithError:回调会被触发，录音完成后, NIMMediaManagerDelgate中的recordAudio:didCompletedWithError:回调会被触发
 *              默认使用 aac 编码格式
 */
 ...
 *  @param type     音频类型
 *  @param duration 最大时长
 *  @discussion 开始录音，QYKFNIMMediaManagerDelegate中的recordAudio:didBeganWithError:回调会被触发，录音完成后, QYKFNIMMediaManagerDelegate中的recordAudio:didCompletedWithError:回调会被触发
 */
- (void)record:(QYKFNIMAudioType)type
      duration:(NSTimeInterval)duration;

/**
 *  停止录制音频
 *
 *  @discussion 停止录音后QYKFNIMMediaManagerDelegate中的recordAudio:didCompletedWithError:回调会被触发
 */
- (void)stopRecord;
 ...
 *  取消录制音频
 *
 *  @discussion 录音取消后，QYKFNIMMediaManagerDelegate中的recordAudioDidCancelled回调会被触发
 */
- (void)cancelRecord;
 ...
 *  @param result  完成回调
 */
- (void)transAudioToText:(QYKFNIMAudioToTextOption *)option
                  result:(QYKFNIMAudioToTextBlock)result;
 ...
 */
- (void)addDelegate:(id<QYKFNIMMediaManagerDelegate>)delegate;
 ...
 *  @param delegate 多媒体委托
 */
- (void)removeDelegate:(id<QYKFNIMMediaManagerDelegate>)delegate;
