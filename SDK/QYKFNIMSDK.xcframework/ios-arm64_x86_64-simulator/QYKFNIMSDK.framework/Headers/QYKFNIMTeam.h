 ...
 *  群组信息
 */
@interface QYKFNIMTeam : NSObject
/**
 *  群ID
 */
 ...
 *  群类型
 */
@property (nonatomic,assign,readonly)    QYKFNIMTeamType type;
 ...
 */
@property (nonatomic,assign,readonly)   QYKFNIMTeamNotifyState notifyStateForNewMsg;
 ...
 *  @discussion 只有高级群、超大群有效
 */
@property (nonatomic,assign,readonly)   QYKFNIMTeamAllMuteMode allMuteMode;
