 ...
 *  群组协议
 */
@protocol QYKFNIMTeamManager <NSObject>
/**
 *  获取所有群组
 *
 *  @return 返回所有群组
 */
- (nullable NSArray<QYKFNIMTeam *> *)allMyTeams;
 ...
 */
- (nullable QYKFNIMTeam *)teamById:(NSString *)teamId;
 ...
 *  @discussion 如果自己不在群里，则该接口返回 nil
 */
- (nullable QYKFNIMTeam *)teamById2:(NSString *)teamId;
 ...
 */
- (void)createTeam:(QYKFNIMCreateTeamOption *)option
              users:(NSArray<NSString *> *)users
         completion:(nullable QYKFNIMTeamCreateHandler)completion;
 ...
 *  @param completion 完成后的回调
 */
- (void)createTeam:(QYKFNIMCreateTeamExOption *)option
        completion:(nullable QYKFNIMTeamCreateHandler)completion;
...
- (void)dismissTeam:(NSString *)teamId
         completion:(nullable QYKFNIMTeamHandler)completion;
...
- (void)addUsers:(NSArray<NSString *>  *)users
      ...
      completion:(nullable QYKFNIMTeamMemberHandler)completion;
 ...
 *  @param completion  完成后的回调
 */
- (void)updateTeamInviteMode:(QYKFNIMTeamInviteMode)inviteMode
                      teamId:(NSString *)teamId
                  completion:(nullable QYKFNIMTeamHandler)completion;
 ...
 *  @param completion   完成后的回调
 */
- (void)updateTeamBeInviteMode:(QYKFNIMTeamBeInviteMode)beInviteMode
                        teamId:(NSString *)teamId
                    completion:(nullable QYKFNIMTeamHandler)completion;
 ...
 *  @param completion     完成后的回调
 */
- (void)updateTeamUpdateInfoMode:(QYKFNIMTeamUpdateInfoMode)updateInfoMode
                          teamId:(NSString *)teamId
                      completion:(nullable QYKFNIMTeamHandler)completion;
 ...
 *  @param completion       完成后的回调
 */
- (void)updateTeamUpdateClientCustomMode:(QYKFNIMTeamUpdateClientCustomMode)clientCustomMode
                                  teamId:(NSString *)teamId
                              completion:(nullable QYKFNIMTeamHandler)completion;
...
- (void)applyToTeam:(NSString *)teamId
         ...
         completion:(nullable QYKFNIMTeamApplyHandler)completion;
 ...
 *  @param completion   完成后的回调
 */
- (void)updateNotifyState:(QYKFNIMTeamNotifyState)state
                   inTeam:(NSString *)teamId
               completion:(nullable QYKFNIMTeamHandler)completion;
 ...
 *  @return 群通知状态
 */
- (QYKFNIMTeamNotifyState)notifyStateForNewMsg:(NSString *)teamId;
...
- (void)getTeamMemberList:(NSString *)teamId
                   option:(QYKFNIMTeamMemberRoleTypeSearchOption *)option
               completion:(nullable QYKFNIMTeamMemberSearchResultHandler)completion;
...
- (void)fetchInviterAccids:(NSString *)teamID
         withTargetMembers:(NSArray<NSString *> *)memberIDs
                completion:(nullable QYKFNIMTeamFetchInviterAccidsHandler)completion;
...
- (void)fetchTeamInfo:(NSString *)teamId
           completion:(nullable QYKFNIMTeamFetchInfoHandler)completion;
 ...
 */
- (nullable QYKFNIMTeamMember *)teamMember:(NSString *)userId
                                inTeam:(NSString *)teamId;
...
*  @discussion   返回本地缓存的群成员信息，如果本地没有相应数据则返回 nil。
*/
- (void)searchTeamWithOption:(QYKFNIMTeamSearchOption *)option
                  completion:(QYKFNIMTeamSearchHandler)completion;
 ...
 */
- (BOOL)updateTInfosLocal:(NSArray<QYKFNIMTeam *> *) teams;
 ...
 */
- (void)fetchTeamsWithTimestamp:(NSTimeInterval)timestamp completion:(nullable QYKFNIMTeamFetchTeamsHandler)block;
/**
*  获取指定群ID的群信息
*
...
*/
- (void)fetchTeamInfoList:(NSArray <NSString *>*)teamIds completion:(QYKFNIMTeamFetchTeamInfoListHandler)block;
 ...
 *  @param delegate 群组委托
 */
- (void)addDelegate:(id<QYKFNIMTeamManagerDelegate>)delegate;
 ...
 *  @param delegate 群组委托
 */
- (void)removeDelegate:(id<QYKFNIMTeamManagerDelegate>)delegate;
@end
