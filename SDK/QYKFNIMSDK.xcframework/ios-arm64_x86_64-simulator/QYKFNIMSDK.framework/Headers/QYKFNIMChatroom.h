 ...
 *  聊天室队列修改权限
 */
typedef NS_ENUM(NSInteger, QYKFNIMChatroomQueueModificationLevel){
    /**
     *  所有人都可以修改聊天室队列
     */
        QYKFNIMChatroomQueueModificationLevelAnyone,
    /**
     *  只有管理员可以修改聊天室队列
     */
        QYKFNIMChatroomQueueModificationLevelManager,
};
 ...
 *  聊天室
 */
@interface QYKFNIMChatroom : NSObject
 ...
 *  聊天室队列修改权限等级
 */
@property (nonatomic,assign)   QYKFNIMChatroomQueueModificationLevel queueModificationLevel;
