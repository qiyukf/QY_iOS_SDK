 ...
 *  客户端类型
 */
typedef NS_ENUM(NSInteger, QYKFNIMLoginClientType) {
    
    /**
     *  未知类型
     */
    QYKFNIMLoginClientTypeUnknown    = 0,
    /**
     *  Android
     */
    QYKFNIMLoginClientTypeAOS         = 1,
    /**
     *  iOS
     */
    QYKFNIMLoginClientTypeiOS         = 2,
    /**
     *  PC
     */
    QYKFNIMLoginClientTypePC          = 4,
    /**
     *  WP
     */
    QYKFNIMLoginClientTypeWP          = 8,
    /**
     *  WEB
     */
    QYKFNIMLoginClientTypeWeb         = 16,
    /**
     *  REST API
     */
    QYKFNIMLoginClientTypeRestful     = 32,
    /**
     *  macOS
     */
    QYKFNIMLoginClientTypemacOS       = 64,
    /**
     *  HarmonyOS
     */
    QYKFNIMLoginClientTypeHarmonyOS   = 65,
};
 ...
 *  登录客户端描述
 */
@interface QYKFNIMLoginClient : NSObject
/**
 *  类型
 */
@property (nonatomic,assign,readonly)   QYKFNIMLoginClientType      type;
/**
 *  操作系统
 */
 ...
 *  自动登录参数
 */
@interface QYKFNIMAutoLoginData : NSObject
/**
 *  账号
 */
 ...
 * 服务器时间
 */
@interface QYKFNIMServerTime : NSObject
