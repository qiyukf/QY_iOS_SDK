 ...
 *  聊天室用户类型
 */
typedef NS_ENUM(NSInteger, QYKFNIMChatroomMemberType) {
    /**
     *  普通游客
     */
    QYKFNIMChatroomMemberTypeGuest   = -2,
    /**
     *  受限用户
     */
    QYKFNIMChatroomMemberTypeLimit   = -1,
    /**
     *  普通用户
     */
    QYKFNIMChatroomMemberTypeNormal  = 0,
    /**
     *  创建者
     */
    QYKFNIMChatroomMemberTypeCreator = 1,
    /**
     *  管理员
     */
    QYKFNIMChatroomMemberTypeManager = 2,
    /**
     *  匿名游客
     */
    QYKFNIMChatroomMemberTypeAnonymousGuest = 4,
};

/**
 *  聊天室用户
 */
@interface QYKFNIMChatroomMember : NSObject
 ...
 *  用户类型
 */
@property (nonatomic,assign) QYKFNIMChatroomMemberType type;
