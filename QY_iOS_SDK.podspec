Pod::Spec.new do |s|
    ...
    s.source   = { :git => 'https://github.com/qiyukf/QY_iOS_SDK.git', :tag => "6.0.0" }
    s.platform = :ios, '9.0'
    ...
    s.resources  = ['**/Resources/QYResource.bundle', '**/Resources/QYLanguage.bundle']
    s.dependency 'NIMSDK_LITE', '8.2.1'
